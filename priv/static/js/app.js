...
channel.on('ReceiveMentions', function (payload) {
...
channel.on('ReceiveQueryResults', function (payload) {
...
channel.on('AddToFollowsList', function (payload) {
...
channel.on('ReceiveHashtags', function (payload) {
