defmodule Twitter.MuginuChannel do
  ...
  def handle_in("tweet", payload, socket) do
    ...
    # Send the tweet to the followers
  ...
  def getHashtags([index | rest], hashtagTweets) do
    [{index, username, content, isRetweet, org_tweeter}] =
                            :ets.lookup(:tweetsDB, index)
  ...
  @doc """
  Fetch the mentions of hashtags or users
  """
  ...
  @doc """
  Handle the tweets which have hashtags
  """
  ...
  def handle_in("queryTweets", payload, socket) do
    ...
    mapSet =
          if :ets.lookup(:followsTable, username) == [] do
            ...
            [{_, set}] =
                :ets.lookup(:followsTable, username)
            set
          end
  ...
  @doc """
  Search the mentions of the users
  """
  ...
  @doc """
  Send the tweets to their respective followers
  """
